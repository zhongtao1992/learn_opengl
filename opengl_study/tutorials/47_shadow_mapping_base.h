...
static int tutorial47() {
	...
	shadowShader.initWithDiskFile("shader/47_shadow_mapping_base.vert", "shader/47_shadow_mapping_base.frag");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		program.setMatrix4fv("u_lightSpaceMatrix", glm::value_ptr(lightSpaceMatrix));		
		// floor
		...
		shadowShader.setMatrix4fv("u_lightSpaceMatrix", glm::value_ptr(lightSpaceMatrix));
