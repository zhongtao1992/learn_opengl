...
static int tutorial18() {
	...
	program.initWithDiskFile("shader/18_material_object.vert", "shader/18_material_object.frag");
	...
	// set material
	program.setVec3("u_material.ambient", 1.0f, 0.5f, 0.31f);
	program.setVec3("u_material.diffuse", 1.0f, 0.5f, 0.31f);
	program.setVec3("u_material.specular", 0.5f, 0.5f, 0.5f);
