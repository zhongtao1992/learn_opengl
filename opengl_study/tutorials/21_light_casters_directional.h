...
static int tutorial21() {
	...
	program.initWithDiskFile("shader/21_material_object.vert", "shader/21_material_object.frag");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		program.setVec3("u_light.direction", -0.2f, -1.0f, -0.3f);
