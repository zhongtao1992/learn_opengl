...
static int tutorial49() {
	...
	program.initWithDiskFile("shader/49_normal_mapping.vert", "shader/49_normal_mapping.frag");
	...
	diffuseMap.loadImg("res/brickwall.jpg");
	ImageLoader normalMap;
	normalMap.loadImg("res/brickwall_normal.jpg");
