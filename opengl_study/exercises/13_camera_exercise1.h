...
static std::string des13() {
	return "transform the camera class in such a way that it becomes a true fps camera where you cannot fly; you can only look around while staying on the xz plane\n";
}

// create a camera view and change the lookat views per frame
static int exercise13() {
	// config opengl
