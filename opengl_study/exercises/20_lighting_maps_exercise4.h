...
static std::string des20() {
	return "emission map\n";

}

// lighting
static int exercise20() {
	// config opengl
	...
	program.initWithDiskFile("shader/20_material_object_exercise.vert", "shader/20_material_object_exercise.frag");
	...
	// load emission maps
	ImageLoader emissionMap;
	emissionMap.defaultLoadJPG("res/matrix.jpg");
	...
	program.setInt("u_material.emission", 4);
