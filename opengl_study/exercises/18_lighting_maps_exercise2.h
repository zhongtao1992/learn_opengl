...
static std::string des18() {
	return "inverting the color values of the specular map in the fragment shader so that the wood shows specular highlights and the steel borders do not \n";

}
// lighting
static int exercise18() {
	// config opengl
	...
	program.initWithDiskFile("shader/18_material_object_exercise.vert", "shader/18_material_object_exercise.frag");
