...
static std::string des10() {
	return "Using the last transformation on the container, try switching the order around by first rotating and then translating\n";
}

// transform object
static int exercise10() {
	// config opengl
